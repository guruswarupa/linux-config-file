...
local menu_browser = {"  Browser", "brave-browser"}
...
if has_fdo then
    mymainmenu = freedesktop.menu.build({
        before = { menu_awesome },
        after =  { menu_terminal,menu_browser,menu_files }
    })
else
...
-- Application switcher using Alt + Tab
	awful.key({ "Mod1" }, "Tab",
    function ()
        awful.spawn.with_shell("rofi -show window")
    end,
    {description = "application switcher", group = "client"}
),
    ...
    -- Launch Visual Studio Code with Mod + Shift + c
    ...
    {description = "launch GNOME Calculator", group = "launcher"}
),
    -- Menubar
    awful.key({ modkey }, "d",
    function ()
